...
<body>
	...
	<div class="form-container">
		...
		<form name="register" action="insert_user.php" onsubmit="return validate()" method="POST">
	...
	<div class="notice">Already have an account? Login <a href="login_page.php">here</a>.</div>
	</center>
